//! \file Tile.h
//! \brief Defines the <code>fullsail_ai::Tile</code> class.
//! \author Cromwell D. Enage
#ifndef _FULLSAIL_AI_PATH_PLANNER_TILE_H_
#define	_FULLSAIL_AI_PATH_PLANNER_TILE_H_
...
#endif  // _FULLSAIL_AI_PATH_PLANNER_TILE_H_
