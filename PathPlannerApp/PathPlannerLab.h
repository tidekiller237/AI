...
// October 2010
#ifndef _FULLSAIL_AI_PATH_PLANNER_LAB_H_
#define _FULLSAIL_AI_PATH_PLANNER_LAB_H_
...
public:
	GroundUpPathPlanner(fullsail_ai::TileMap& tiles);
	bool isReady() const;
...
#endif  // _FULLSAIL_AI_PATH_PLANNER_LAB_H_
